...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 1151,            /* -m128bit-long-double */
  OPT_m16 = 1152,                            /* -m16 */
  OPT_m32 = 1153,                            /* -m32 */
  OPT_m3dnow = 1154,                         /* -m3dnow */
  OPT_m3dnowa = 1155,                        /* -m3dnowa */
  OPT_m64 = 1156,                            /* -m64 */
  OPT_m80387 = 1157,                         /* -m80387 */
  OPT_m8bit_idiv = 1158,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1159,             /* -m96bit-long-double */
  OPT_mabi_ = 1160,                          /* -mabi= */
  OPT_mabm = 1161,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1162,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1163,                 /* -maddress-mode= */
  OPT_madx = 1164,                           /* -madx */
  OPT_maes = 1165,                           /* -maes */
  OPT_malign_data_ = 1166,                   /* -malign-data= */
  OPT_malign_double = 1167,                  /* -malign-double */
  OPT_malign_functions_ = 1168,              /* -malign-functions= */
  OPT_malign_jumps_ = 1169,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1170,                  /* -malign-loops= */
  OPT_malign_stringops = 1171,               /* -malign-stringops */
  ...
  OPT_mbmi = 1190,                           /* -mbmi */
  OPT_mbmi2 = 1191,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1192,                  /* -mbranch-cost= */
  OPT_mcld = 1193,                           /* -mcld */
  OPT_mclflushopt = 1194,                    /* -mclflushopt */
  OPT_mclwb = 1195,                          /* -mclwb */
  OPT_mclzero = 1196,                        /* -mclzero */
  OPT_mcmodel_ = 1197,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1198, */                    /* -mcpu= */
  OPT_mcrc32 = 1199,                         /* -mcrc32 */
  OPT_mcx16 = 1200,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1201,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1202,            /* -mdump-tune-features */
  OPT_mf16c = 1203,                          /* -mf16c */
  OPT_mfancy_math_387 = 1204,                /* -mfancy-math-387 */
  OPT_mfentry = 1205,                        /* -mfentry */
  OPT_mfma = 1206,                           /* -mfma */
  OPT_mfma4 = 1207,                          /* -mfma4 */
  OPT_mforce_drap = 1208,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1209,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1210,                       /* -mfpmath= */
  OPT_mfsgsbase = 1211,                      /* -mfsgsbase */
  ...
  OPT_minline_all_stringops = 1220,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1221,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1222, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1223,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1224,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1225,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1226,                /* -mlong-double-80 */
  OPT_mlwp = 1227,                           /* -mlwp */
  OPT_mlzcnt = 1228,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1229,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1230,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1231,                  /* -mmitigate-rop */
  OPT_mmmx = 1232,                           /* -mmmx */
  OPT_mmovbe = 1233,                         /* -mmovbe */
  OPT_mmpx = 1234,                           /* -mmpx */
  OPT_mms_bitfields = 1235,                  /* -mms-bitfields */
  OPT_mmwaitx = 1236,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1237,            /* -mno-align-stringops */
  OPT_mno_default = 1238,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1239,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1240,                  /* -mno-push-args */
  OPT_mno_red_zone = 1241,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1242,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1243,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1244,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1245,                          /* -mpc32 */
  OPT_mpc64 = 1246,                          /* -mpc64 */
  OPT_mpc80 = 1247,                          /* -mpc80 */
  OPT_mpclmul = 1248,                        /* -mpclmul */
  OPT_mpcommit = 1249,                       /* -mpcommit */
  OPT_mpku = 1250,                           /* -mpku */
  OPT_mpopcnt = 1251,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1252,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1253,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1254,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1255,                        /* -mprfchw */
  OPT_mpush_args = 1256,                     /* -mpush-args */
  OPT_mrdpid = 1257,                         /* -mrdpid */
  ...
  OPT_msgx = 1268,                           /* -msgx */
  OPT_msha = 1269,                           /* -msha */
  OPT_mskip_rax_setup = 1270,                /* -mskip-rax-setup */
  OPT_msoft_float = 1271,                    /* -msoft-float */
  OPT_msse = 1272,                           /* -msse */
  OPT_msse2 = 1273,                          /* -msse2 */
  OPT_msse2avx = 1274,                       /* -msse2avx */
  OPT_msse3 = 1275,                          /* -msse3 */
  OPT_msse4 = 1276,                          /* -msse4 */
  OPT_msse4_1 = 1277,                        /* -msse4.1 */
  OPT_msse4_2 = 1278,                        /* -msse4.2 */
  OPT_msse4a = 1279,                         /* -msse4a */
  /* OPT_msse5 = 1280, */                    /* -msse5 */
  OPT_msseregparm = 1281,                    /* -msseregparm */
  OPT_mssse3 = 1282,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1283,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1284,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1285,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1286,            /* -mstringop-strategy= */
  OPT_mstv = 1287,                           /* -mstv */
  OPT_mtbm = 1288,                           /* -mtbm */
  OPT_mtls_dialect_ = 1289,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1290,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1291,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1292,                         /* -mtune= */
  OPT_mveclibabi_ = 1293,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1294,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1295,                    /* -mvzeroupper */
  OPT_mx32 = 1296,                           /* -mx32 */
  OPT_mxop = 1297,                           /* -mxop */
  OPT_mxsave = 1298,                         /* -mxsave */
  OPT_mxsavec = 1299,                        /* -mxsavec */
  OPT_mxsaveopt = 1300,                      /* -mxsaveopt */
  OPT_mxsaves = 1301,                        /* -mxsaves */
  OPT_n = 1302,                              /* -n */
  OPT_no_canonical_prefixes = 1303,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1304,              /* -no-integrated-cpp */
  OPT_no_pie = 1305,                         /* -no-pie */
  OPT_nocpp = 1306,                          /* -nocpp */
  OPT_nodefaultlibs = 1307,                  /* -nodefaultlibs */
  ...
  OPT_r = 1332,                              /* -r */
  OPT_remap = 1333,                          /* -remap */
  OPT_s = 1334,                              /* -s */
  OPT_save_temps = 1335,                     /* -save-temps */
  OPT_save_temps_ = 1336,                    /* -save-temps= */
  OPT_shared = 1337,                         /* -shared */
  OPT_shared_libgcc = 1338,                  /* -shared-libgcc */
  /* OPT_specs = 1339, */                    /* -specs */
  OPT_specs_ = 1340,                         /* -specs= */
  OPT_static = 1341,                         /* -static */
  OPT_static_libasan = 1342,                 /* -static-libasan */
  OPT_static_libgcc = 1343,                  /* -static-libgcc */
  OPT_static_libgfortran = 1344,             /* -static-libgfortran */
  OPT_static_libgo = 1345,                   /* -static-libgo */
  OPT_static_liblsan = 1346,                 /* -static-liblsan */
  OPT_static_libmpx = 1347,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1348,          /* -static-libmpxwrappers */
  ...
  OPT_std_c__98 = 1359,                      /* -std=c++98 */
  OPT_std_c11 = 1360,                        /* -std=c11 */
  /* OPT_std_c1x = 1361, */                  /* -std=c1x */
  /* OPT_std_c89 = 1362, */                  /* -std=c89 */
  OPT_std_c90 = 1363,                        /* -std=c90 */
  OPT_std_c99 = 1364,                        /* -std=c99 */
  /* OPT_std_c9x = 1365, */                  /* -std=c9x */
  OPT_std_f2003 = 1366,                      /* -std=f2003 */
  OPT_std_f2008 = 1367,                      /* -std=f2008 */
  OPT_std_f2008ts = 1368,                    /* -std=f2008ts */
  OPT_std_f95 = 1369,                        /* -std=f95 */
  OPT_std_gnu = 1370,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1371, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1372, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1373,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1374,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1375, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1376, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1377,                    /* -std=gnu++1z */
  ...
  OPT_std_legacy = 1390,                     /* -std=legacy */
  OPT_symbolic = 1391,                       /* -symbolic */
  OPT_t = 1392,                              /* -t */
  OPT_time = 1393,                           /* -time */
  OPT_time_ = 1394,                          /* -time= */
  OPT_traditional = 1395,                    /* -traditional */
  OPT_traditional_cpp = 1396,                /* -traditional-cpp */
  OPT_trigraphs = 1397,                      /* -trigraphs */
  OPT_u = 1398,                              /* -u */
  OPT_undef = 1399,                          /* -undef */
  OPT_v = 1400,                              /* -v */
  OPT_version = 1401,                        /* -version */
  OPT_w = 1402,                              /* -w */
  OPT_wrapper = 1403,                        /* -wrapper */
  OPT_x = 1404,                              /* -x */
  OPT_z = 1405,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
